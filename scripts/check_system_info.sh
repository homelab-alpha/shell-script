...
# Description: This script checks system information before publishing it to GitHub. It provides details about system uptime, hardware information, system temperature, systemctl status, RAM/SWAP usage, disk usage, disk usage inodes, and last reboot/shutdown events.
# Author: GJS (homelab-alpha)
# Date: 2024-03-12T15:06:26Z

# Usage: ./check_system_info.sh

# Example:
# To check system information, execute the script in a terminal:
